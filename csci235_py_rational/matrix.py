...
class Matrix( object ) : 
   ...
   def __mul__( self, other ) :
      if isinstance( other, Matrix ) : 
         raise ValueError( "you confuse the operator. Use @" ) 

      if isinstance( other, Vector ) :
         raise ValueError( "you confuse the operator use m(v)" )
   ...
   def __truediv__( self, other ) :
      if isinstance( other, Matrix ) :
         raise ValueError( "dividing matrices is not possible" );
   ...
   def __matmul__( self, other ) :
      if not isinstance( other, Matrix ) :
         raise ValueError( "you cannot apply @ on a matrix and a vector" )
   ...
   def __eq__( self, other ) :
      return ( self.a11 == other.a11 and
               self.a12 == other.a12 and
               self.a21 == other.a21 and
               self.a22 == other.a22 )  

   def __ne__( self, other ) :
      return ( self.a11 != other.a11 or 
               self.a12 != other.a12 or
               self.a21 != other.a21 or
               self.a22 != other.a22 ) 
